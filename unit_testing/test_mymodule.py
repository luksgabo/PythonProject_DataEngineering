...
class TestAdd(unittest.TestCase): 
    ...
    def test1(self): 
        ...
        # test when 2, 2 is given as input the output is 4.
        self.assertEqual(add(-3.1, -3.1), -6.2) 
        # test when -3.1, -3.1 is given as input the output is -6.2
        self.assertEqual(add(0, 0), 0) 
        # test when 0, 0 is given as input the output is 0.
